...
<body>
    <div class="mail-content">
        ...
        <div class="content">
            ...
            <h1 class="subject">Subject: ⚠️ Overdue Journal Alert – Late Fee Applies</h1>

            <h1 class="greetings">Dear [User's Name],</h1>

            <p class="message">We noticed that your borrowed journal, "[Journal Title]", was due on [Return Date] and has not been returned yet. As of today, a late fee of ₹[Total Fine] has been applied to your account. 📢 Late Fee Policy: ₹[Fine Amount] per day after the due date. To avoid further penalties, please return the journal at your earliest convenience. If you have already returned it, kindly ignore this email.
            </p>
