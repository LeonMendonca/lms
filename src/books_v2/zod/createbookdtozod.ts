...
const createBookTitleObject = createObjectOmitProperties(new BookTitle(), [
  'availableCount',
  'totalCount',
  'updatedAt',
  'createdAt',
...
const createBookCopyObject = createObjectOmitProperties(new BookCopy(), [
  'bookCopyUUID',
  'isArchived',
  'isAvailable',
  'bookCopyId',
...
export const createBookSchema = z.object({
  ...
  [createBookTitleObject.isbn]: z.string().refine(
    (isbn) => {
